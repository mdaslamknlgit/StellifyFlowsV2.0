...
@Component({
  selector: 'app-crmactivity',
  templateUrl: './crmactivity.component.html',
  styleUrls: ['./crmactivity.component.css']
})
export class CrmactivityComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ActivityForm.controls['ActivitySubject'].setValue(this.ContactData.FullName);
    ...
    else 
    {
      ...
      if(this.StartDate==null)
      {
          ...
          const AnniversaryYear = Number(this.datePipe.transform(this.StartDateD, 'yyyy'));
          const AnniversaryMonth = Number(this.datePipe.transform(this.StartDateD, 'MM'));
          const AnniversaryDay = Number(this.datePipe.transform(this.StartDateD, 'dd'));
