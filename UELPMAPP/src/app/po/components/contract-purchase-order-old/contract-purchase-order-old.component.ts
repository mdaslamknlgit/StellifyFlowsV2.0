...
@Component({
    selector: 'app-contract-purchase-order-old',
    templateUrl: './contract-purchase-order-old.component.html',
    styleUrls: ['./contract-purchase-order-old.component.css'],
...
export class ContractPurchaseOrderOldComponent implements OnInit {
