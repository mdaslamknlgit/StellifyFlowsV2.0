...
import { PurchaseOrderList, PurchaseOrderTypes } from '../../models/po-creation.model';
...
export class GoodReceivedNotesComponent implements OnInit {
    ...
    constructor(private reqDateFormatPipe: RequestDateFormatPipe, private pocreationObj: POCreationService,
    ...
    ngOnInit() {
        ...
        {
            this.moduleHeading = "Goods Received Notes";
        }
        ...
        this.goodsReceivedNotesPagerConfig.RecordsToFetch = 8;
    ...
    */
    saveGRNDetails(statusId: number) {
        ...
        if (formStatus != "INVALID") {
            ...
            //Need to add POTypeId as 1

            this.goodsReceivedNotesForm.controls.POTypeId.setValue(this.PurchaseOrderTypeId);
    ...
    ClickBack(e)
    {
        this.router.navigate([`/po/goodsreceivednoteslist/${this.requestType}`]);
    }
    /**
    ...
    getPoSelectionData(purchaseOrderId: number, purchaseOrderTypeId: number) {
        this.deliveryCreationObj.getGoodsReceivedNotesDetails(0, purchaseOrderId, purchaseOrderTypeId, this.companyId)
            .subscribe((data: { purchaseOrderDetails: any, totalReceivedQty: Array<GoodsReceivedNotesItems> }) => {
                ...
                this.isSameUSer = (purchaseOrderDetails.CreatedBy == LoggedInUserId) ? true : false;
        ...
        this.deliveryCreationObj.getFilterGRN(grnFilterDisplayInput)
            ...
            .subscribe((data: GoodsReceivedNotesDisplayResult) => {
                if (data.TotalRecords > 0) {
                    ...
                    this.goodsReceivedNotesList = data.GoodsReceivedNotes;
                    debugger;
                    this.onRecordSelection(this.goodsReceivedNotesList[0].GoodsReceivedNoteId, this.goodsReceivedNotesList[0].PurchaseOrderId
                        , this.goodsReceivedNotesList[0].POTypeId);
                }
                else {
                    this.filterMessage = "No matching records are found";
