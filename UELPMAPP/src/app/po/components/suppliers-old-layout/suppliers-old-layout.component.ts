...
@Component({
  selector: 'app-suppliers-old-layout',
  templateUrl: './suppliers-old-layout.component.html',
  styleUrls: ['./suppliers-old-layout.component.css'],
  providers: [{ provide: NgbDateAdapter, useClass: NgbDateNativeAdapter }]
})
export class SuppliersOldLayoutComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    this.supplierPagerConfig.RecordsToFetch = 10;
    this.currentPage = 1;
...
this.showfilterstext="Hide List" 
  ...
  resetPagerConfig() {
    this.supplierPagerConfig.RecordsToSkip = 0;
    this.supplierPagerConfig.RecordsToFetch = 5;
    this.currentPage = 1;
  }
