...
@Component({
    selector: 'app-project-contract-master-list',
    templateUrl: './project-contract-master-list.component.html',
    styleUrls: ['./project-contract-master-list.component.css'],
...
export class ProjectContractMasterListComponent implements OnInit {
    ...
    moduleHeading = "Project Contract Master List";
    companyId: number = 0;
    supplierid: number;
