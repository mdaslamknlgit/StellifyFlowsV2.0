...
@Component({
    selector: 'app-payment-terms-old',
    templateUrl: './payment-terms-old.component.html',
    styleUrls: ['./payment-terms-old.component.css'],
    providers: [PaymentTermsService]
})
export class PaymentTermsOldComponent implements OnInit {
