...
export class PoListComponent implements OnInit {
    ...
    SetIntialDates() {
        ...
        this.poFilterInfoForm.controls.FromDate.markAsTouched();
        this.poFilterInfoForm.controls.ToDate.markAsTouched();
    ...
    ngOnInit() {
        ...
        this.PurchaseOrdersListsCols = [
            ...
            { field: 'POTypeId', header: 'PO Type', width: '150px' },
    ...
    GetPurchaseOrderTypeName(id: number) {
        let A=this.purchaseOrderTypes.filter(x=>x.PurchaseOrderTypeId==id)[0].PurchaseOrderType;
        return A;
    ...
    getAllSearchPurchaseOrder(searchKey: string, purchaseOrderIdToBeSelected: number, potypeId: number, 
        isNotification: boolean = false, poFilterData?: PurchaseOrderFilterModel) {
        //debugger;
