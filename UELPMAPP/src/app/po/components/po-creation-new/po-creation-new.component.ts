...
@Component({
    selector: 'app-po-creation-new',
    templateUrl: './po-creation-new.component.html',
    styleUrls: ['./po-creation-new.component.css'],
    providers: [POCreationService, { provide: NgbDateAdapter, useClass: NgbDateNativeAdapter }]
})
export class PoCreationNewComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.paramMap.subscribe((param: ParamMap) => {
            if (param.get('poorderid') != undefined) {
                this.pPurchaseOrderId = this.activatedRoute.snapshot.paramMap.get('poorderid');
                this.POOrderId = parseInt(this.pPurchaseOrderId);
            }
            if (param.get('poordertypeid') != undefined) {
                this.pPurchaseOrderTypeId = this.activatedRoute.snapshot.paramMap.get('poordertypeid');
            ...
            if (param.get('supplierid') != undefined) {
                this.pSupplierId = this.activatedRoute.snapshot.paramMap.get('supplierid');
