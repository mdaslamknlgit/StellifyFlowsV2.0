...
export class WorkFlowListComponent {
  ...
  ngOnInit() {
    this.workFlowConfigurationsCols = [
  ...
  addData() {
    ...
    this.previousConfigurationId = 0;
    this.resetControls();
    this.router.navigate([`/admin/workflowe/${'NEW'}/${0}/${0}/${0}`]);
  ...
  EditWorkFlow(configuration: WorkFlowConfigurationList) {
    ...
    //this.router.navigate([`/admin/workflowe`]);

    debugger;
    this.router.navigate([`/admin/workflowe/${'EDIT'}/${configuration.ProcessId}/${configuration.CompanyId}/${configuration.LocationID}`]);
