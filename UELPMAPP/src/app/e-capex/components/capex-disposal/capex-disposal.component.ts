...
@Component({
  selector: 'app-capex-disposal',
  templateUrl: './capex-disposal.component.html',
  styleUrls: ['./capex-disposal.component.css']
})
export class CapexDisposalComponent implements OnInit {
