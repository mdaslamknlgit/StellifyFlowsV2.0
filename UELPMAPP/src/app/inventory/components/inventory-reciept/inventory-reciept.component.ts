...
@Component({
  selector: 'app-inventory-reciept',
  templateUrl: './inventory-reciept.component.html',
  styleUrls: ['./inventory-reciept.component.css']
})
export class InventoryRecieptComponent implements OnInit {
