...
@Component({
    selector: 'app-item-master-old',
    templateUrl: './item-master-old.component.html',
    styleUrls: ['./item-master-old.component.css'],
    providers: [ItemMasterService, { provide: NgbDateAdapter, useClass: NgbDateNativeAdapter }]
})
export class ItemMasterOldComponent implements OnInit {
    ...
    constructor(private itemmasterServiceObj: ItemMasterService,
    ...
    ngOnInit() {
        ...
        this.itemMasterPagerConfig.RecordsToFetch = 6;
