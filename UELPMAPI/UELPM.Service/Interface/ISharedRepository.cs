...
namespace UELPM.Service.Interface
{
    public interface ISharedRepository
    {
        ...
        void SendForApproval(WorkFlowParameter workFlowApproval, bool isFromUi, IDbTransaction dbTransaction = null, IDbConnection dbConnection = null);
        ...
        IEnumerable<AccountCode> GetAccountCodesByCategory(int categoryId, int companyId, string searchkey);
        ...
        IEnumerable<AccountCode> GetExpenseBykey(string serachkey, int companyId);
        ...
        int PostDocumentAddress(DocumentAddress address, IDbTransaction dbTransaction = null);
